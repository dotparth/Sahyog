...
public class Req2adapter extends RecyclerView.Adapter<Req2adapter.MyViewHolder> {
    ...
    public Req2adapter( Context context, ArrayList<req2data> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        final  req2data user = list.get(position);
